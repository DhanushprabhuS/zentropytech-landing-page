...
import { LandingHeroItemNodeSvg } from "./LandingHeroItemNodeSvg"
import { ChangingTextElement } from "./ChangingTextElement"
    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{
            maskType: "alpha",
            WebkitMaskImage: "url(/heroAnimation/hero-beam-mask.svg)",
            maskImage: "url(/heroAnimation/hero-beam-mask.svg)"
          }}
        >
          <div
            key={name}
